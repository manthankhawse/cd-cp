...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KW_ALLOW = 3,                   /* KW_ALLOW  */
  YYSYMBOL_KW_DENY = 4,                    /* KW_DENY  */
  YYSYMBOL_KW_ROLE = 5,                    /* KW_ROLE  */
  YYSYMBOL_KW_ACTION = 6,                  /* KW_ACTION  */
  YYSYMBOL_KW_ON = 7,                      /* KW_ON  */
  YYSYMBOL_KW_RESOURCE = 8,                /* KW_RESOURCE  */
  YYSYMBOL_KW_WHERE = 9,                   /* KW_WHERE  */
  ...
  YYSYMBOL_ATTR_IP = 15,                   /* ATTR_IP  */
  YYSYMBOL_ATTR_TIME = 16,                 /* ATTR_TIME  */
  YYSYMBOL_ATTR_MFA = 17,                  /* ATTR_MFA  */
  YYSYMBOL_ATTR_REGION = 18,               /* ATTR_REGION  */
  YYSYMBOL_ATTR_TAG = 19,                  /* ATTR_TAG  */
  YYSYMBOL_OP_EQ = 20,                     /* OP_EQ  */
  YYSYMBOL_OP_NEQ = 21,                    /* OP_NEQ  */
  YYSYMBOL_OP_LT = 22,                     /* OP_LT  */
  YYSYMBOL_OP_GT = 23,                     /* OP_GT  */
  YYSYMBOL_OP_LEQ = 24,                    /* OP_LEQ  */
  YYSYMBOL_OP_GEQ = 25,                    /* OP_GEQ  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "KW_ALLOW", "KW_DENY",
  "KW_ROLE", "KW_ACTION", "KW_ON", "KW_RESOURCE", "KW_WHERE", "KW_AND",
